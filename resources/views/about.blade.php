...
<html lang="en">
<head>
<title>Estate Town Real Estate Category Flat Bootstrap Responsive Web Template | Services :: w3layouts</title>
<!-- for-mobile-apps -->
...
<!-- Services page -->
<section class="serv bg-light py-5">
	<div class="container py-md-3">
		<h3 class="heading mb-5">Our Services</h3>
		<div class="serv-grids text-center row">
			<div class="col-lg-3 col-sm-6">
				<div class="icon1 px-sm-3">
					<span class="fa fa-map-marker"></span>
					<h3 class="mt-3">Find Places any where in the world</h3>
				</div>
			</div>
			<div class="col-lg-3 col-sm-6 mt-sm-0 mt-4">
				<div class="icon2 px-sm-3">
					<span class="fa fa-users"></span>
					<h3 class="mt-3">We have agents with experience</h3>
				</div>
			</div>
			<div class="col-lg-3 col-sm-6 mt-lg-0 mt-4">
				<div class="icon3 px-sm-3">
					<span class="fa fa-building"></span>
					<h3 class="mt-3">Buy or rent sales Properties</h3>
				</div>
			</div>
			<div class="col-lg-3 col-sm-6 mt-lg-0 mt-4">
				<div class="icon4 px-sm-3">
					<span class="fa fa-mixcloud"></span>
					<h3 class="mt-3">Find your new place with Estate</h3>
				</div>
			</div>
		</div>
	</div>
				...
				<div class="testimonials">
					<div class="active item">
					  ...
					  <div class="carousel-info">
						<img alt="" src="images/t1.jpg" class="pull-left">
						<div class="pull-left">
...
<footer class="footer-emp-w3ls py-5">
	...
	<div class="copy-right-top border-top mt-4">
		<p class="copy-right text-center pt-xl-5 pt-4">&copy; 2018 Estate Town. All Rights Reserved | Design by
